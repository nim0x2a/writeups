...
در این چالش با مثالی از تکنیک [**SROP**](https://writeups.fmc.tf/pwn/wiki/SROP/) روبه‌رو شده و درک می‌کنیم که چگونه میتوان از سیستم‌کال **sigreturn** به درستی و در جهت اکسپلویت برنامه استفاده کرد.
